...
public record TransacaoDadosListagemDTO(
        Long id,
    ...
    public TransacaoDadosListagemDTO(Transacao transacao) {
        this(transacao.getId(), transacao.getDataHoraTransacao(), transacao.getTipo(),
                transacao.getCategoria(), transacao.getDescricao(), transacao.getValor(),
                transacao.getMetodo(), transacao.getUsuario().getId());
    }
}
